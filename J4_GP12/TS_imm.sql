...
$$;
/* vérifie l'existence d'un transporteur*/
...
/* Attribué un status à un client*/
...
/* Attribué un status à un transporteur*/
...
/* Attribué un status à une catégorie*/
...
/* Attribué un status à un produit*/
